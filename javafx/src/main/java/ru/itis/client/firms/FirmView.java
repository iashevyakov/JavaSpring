...
public class FirmView {
    ...
    public static void showFirms() throws FileNotFoundException {

        Stage stage = new Stage();
        Scene scene = new Scene(new Group());
        stage.setTitle("Firms");
        stage.setWidth(300);
        stage.setHeight(515);
        ...
        delete.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                FirmOverviewController.delete(table,firms);
            }
        });
        ...
        add.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent event) {
                FirmOverviewController.add(firms);
            }
        });
        ...
        edit.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent event) {
                FirmOverviewController.edit(table);
            }
        });
