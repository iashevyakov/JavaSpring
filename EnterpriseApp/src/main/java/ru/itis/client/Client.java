    ...
    public void start(Stage primaryStage) {
        ...
        btn.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent e) {
                ...
                UserDataForRegistrationDto userDataForRegistrationDto = new UserDataForRegistrationDto(userTextField.getText(),pwBox.getText(),Integer.valueOf(ageField.getText()),"Ivan");
